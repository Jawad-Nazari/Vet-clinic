...
<div align="center">
  ...
  <h1><b>Veterinary Clinic Database</b></h1>
...
**Veterinary Clinic Database** "In this project, I have used PostgreSQL to create the a database for a vet clinic. I have created a table called animals to store animals information, inserted some data into it, and then created some query to select information."
...
git clone https://github.com/Jawad-Nazari/Vet-clinic.git
